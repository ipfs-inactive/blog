...
- General Changes and Refactorings
  ...
  If you have questions or run into any issues, please post in the [IPFS Discussion and Support Forum](https://discuss.ipfs.io). For bugs, please open an issue in [ipfs/go-ipfs/issues](https://github.com/ipfs/go-ipfs/issues).
