...
![IPFS Pinning Summit](/header_images/093-ipfs-pinning-summit-recap.png)

The first-ever [IPFS Pinning Summit](https://ipfspinningsummit.com/) brought together [IPFS pinning services](https://docs.ipfs.io/guides/concepts/pinning/), infra providers, and users to discuss the current state of IPFS infrastructure, services, and tools - and the future opportunities in this space. 

This 2-day summit was a great opportunity to gather leaders in the space to reflect on our current progress, chart the growth opportunities ahead of us, and band together by offering advice, best practices, and opportunities to collaborate and work together to make IPFS stronger.
