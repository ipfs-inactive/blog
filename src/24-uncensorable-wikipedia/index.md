...
For your convenience we have set up a domain name and DNS entry at [tr.wikipedia-on-ipfs.org](tr.wikipedia-on-ipfs.org) that will resolve to the current IPFS snapshot.
